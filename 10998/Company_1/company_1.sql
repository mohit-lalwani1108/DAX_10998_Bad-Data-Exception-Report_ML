...
SELECT DISTINCT primary_domain as domain , company_country AS countryCode, primary_name AS name, company_status as status, ROUND(NULLIF(revenue, '0')::DOUBLE*1E6) as revenue from daas.dax_10998_temp_20250625 
...
from daas.dax_10998_temp_20250625 
WHERE ROUND(NULLIF(revenue, '0')::DOUBLE*1E6)  > 775000000000  
) where rn = 1
; 
